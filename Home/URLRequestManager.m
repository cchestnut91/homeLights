...
- (void)performStateUpdateWithLightKey:(NSString * __nonnull)lightKey andState:(NSDictionary * __nonnull)state withCompletion:(completionBlock __nullable)completion {
    ...
    [self performBaseRequestWithURL:requestUrl andMethod:@"PUT" andBody:state withCompletion:completion];
}

- (void)performBaseRequestWithURL:(NSURL *)requestUrl andMethod:(NSString *)method andBody:(NSDictionary *)body withCompletion:(completionBlock)completion {
